...
export default function Landing() {
  ...
  return (
    <div className="w-full min-h-screen overflow-x-auto overflow-auto bg-gradient-to-r from-neutral-950 via-neutral-800 to-neutral-950 flex justify-center items-center">
